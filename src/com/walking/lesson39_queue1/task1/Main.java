 ...
 * <a href=
 * "https://github.com/KFalcon2022/practical-tasks/blob/master/src/com/walking/lesson28_generics1/task4/structure/Stack.java">...</a>).
 * <p>
 * Реализуйте метод, разворачивающий односвязный список (первый элемент должен
 * стать последним, второй – предпоследним и т.д.).
 * <p>
 * Также реализуйте метод, удаляющий все узлы, хэшкод элемента которых - четный.
 */
public class Main {
	// В рамках реализации списка я выбрал реализацию в рамках 2й задачи 37го урока.
	// В целом, прямой необходимости
//    делать коллекцию наследником Collection или другого интерфейса не было. Единственная доработка - метод reverse()
	public static void main(String[] args) {
		...
		for (Integer integer : testIntList) {
